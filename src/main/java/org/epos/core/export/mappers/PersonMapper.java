...
public class PersonMapper implements EntityMapper<Person> {
    ...
    @Override
    public Resource exportToV1(Person entity, Model model, Map<String, EPOSDataModelEntity> entityMap, Map<String, Resource> resourceCache) {
    ...
    @Override
    public Resource exportToV3(Person entity, Model model, Map<String, EPOSDataModelEntity> entityMap,
