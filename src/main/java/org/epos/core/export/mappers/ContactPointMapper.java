...
public class ContactPointMapper implements EntityMapper<ContactPoint> {
    ...
    @Override
    public Resource exportToV1(ContactPoint entity, Model model, Map<String, EPOSDataModelEntity> entityMap, Map<String, Resource> resourceCache) {
        ...
        // Add type
        RDFHelper.addType(model, subject, RDFConstants.SCHEMA_CONTACT_POINT_CLASS);
    ...
    @Override
    public Resource exportToV3(ContactPoint entity, Model model, Map<String, EPOSDataModelEntity> entityMap, Map<String, Resource> resourceCache) {
        if (resourceCache.containsKey(entity.getUid())) {
            return resourceCache.get(entity.getUid());
        }
        // Create resource
